<script>
	...
	const profiles = [
		...
		},
		{
			...
			address: '0x3227edf3d8ef577170f339689a128ce229dd8df2',
			zil: '80',
			profileImage: 'https://www.artnews.com/wp-content/uploads/2021/08/BAYC-8746.png?w=631'
		}
	];
	const AdaptiveContentProps = [
		{
			...
			content:
				'The Zilliqa Soul-Bound Token is intended to be a POC token that enables users to own their on-chain identity. At its core, it is non-transferable token that users mint for themselves.',
			img: User,
			subcontent: ''
		},
		{
...
<section class="hero">
	...
	<div class="container flex flex-between flex-items-center">
		<div class="left">
			...
			<p>
				Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sint, ducimus exercitationem
				deleniti veniam voluptates incidunt tempore iste voluptatem impedit! Illo!
			</p>
		...
		<div class="right">
			<img id="tri-gradient" src={triGradient} />
			<div class="card">
				<img
					class="center"
				...
				<div class="card-footer flex flex-between flex-items-center">
					<div class="">
						<h6 class="inline">NFT_CREATOR</h6>
						<p>
							<Icon icon="entypo:wallet" class="inline-block" />
							{String('0x3227edf3d8ef577170f339689a128ce229dd8df2').substring(0, 6) +
								'...' +
								String('0x3227edf3d8ef577170f339689a128ce229dd8df2').substring(38)}
						</p>
					</div>
					<Icon icon="bi:share-fill" width="25" />
				</div>
			</div>
		</div>
	</div>
...
<section class="why-us">
	<img src={triGradient} id="tri-gradient" alt="" />
	<img src={triGradient} id="tri-gradient-2" alt="" />
	<div class="container">
		<h1 class="text-center">Our Platform</h1>
		<ul class="grid">
...
<section class="featured">
	...
	<img src={triGradient} id="tri-gradient-2" alt="" />
	<div class="container">
		<h1 class="text-center">Featured Profiles</h1>
		<div class="grid">
			{#each profiles as user}
				<div class="card">
					<div class="card-top flex flex-between flex-items-center">
						<img class="radius-full center" alt="logo" src={user.profileImage} />
					</div>
					<div class="card-bottom flex flex-between flex-items-center ">
						<div class="">
